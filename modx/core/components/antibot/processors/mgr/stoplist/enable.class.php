...
class antiBotStopListEnableProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            if (!$object = $this->modx->getObject($this->classKey, $id)) {
                return $this->failure($this->modx->lexicon('antibot_istoplist_err_nf'));
            }
...
return 'antiBotStopListEnableProcessor';
