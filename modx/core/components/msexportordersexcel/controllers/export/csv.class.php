<?php
if (!class_exists('msExportOrdersExcelPhpExcelXlsController')) {
    include_once dirname(__FILE__) . '/xls.class.php';
}

class msExportOrdersExcelPHPExcelCSVController extends msExportOrdersExcelPhpExcelXlsController
{
    /* @var string $class */
    protected $class = 'CSV';
...
return 'msExportOrdersExcelPHPExcelCSVController';
