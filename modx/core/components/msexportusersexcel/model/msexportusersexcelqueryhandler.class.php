...
interface msExportUsersExcelQueryInterface
{
    /**
...
class msExportUsersExcelQueryHandler implements msExportUsersExcelQueryInterface
{
    ...
    /**
     * msExportUsersExcelQueryHandler constructor.
    ...
    /**
     * @param array $config
     * @return msExportUsersExcelQueryHandler
     */
