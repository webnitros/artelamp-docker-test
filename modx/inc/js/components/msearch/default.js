...
if (screen.width>768) {
    mse2Config['mode'] = ''; // Для обычной версии
} else {
...
var mSearch2 = {
    ...
    options: {
        ...
        more: '.btn_more',
        more_tpl: '<div class="more_units"><button class="btn btn_black js_btn btn_more">' + mse2Config['moreText'] + '</button></div>',
        ...
        switch (mse2Config['mode']) {
            case 'button':
                ...
                $(document).on('click', this.options['wrapper'] + ' ' + this.options['more'], function (e) {
                    ...
                    //var positionMore = $(mSearch2.options['more']).position().top;
                    // Отключили удаление параметра page из адресной строки при нажатии на показать еще
                    mSearch2.addPage(false,function (params) {
    ...
    load: function (params, callback, append) {
        ...
        if (Object.keys(params).length) {
            this.btn_reset.removeClass('hidden');
            this.btn_reset.closest('.clean_filters').addClass('clean_filters_show');
        } else {
            this.btn_reset.addClass('hidden');
            this.btn_reset.closest('.clean_filters').removeClass('clean_filters_show');
        }
    ...
    addPage: function (removeParamPage, callback) {
        var pcre = new RegExp(mse2Config['pageVar'] + '[=|\/](\\d+)');
