...
Ext.extend(miniShop2.grid.Payment, miniShop2.grid.Default, {
    ...
    getFields: function () {
        return ['id', 'name', 'description', 'price', 'track_order', 'logo', 'rank', 'active', 'class', 'deliveries', 'actions'];
    },
    ...
    getColumns: function () {
        return [
            ...
            {header: 'Заказ отлеживается', dataIndex: 'track_order', width: 50,
                renderer: miniShop2.utils.renderBoolean},
