msPromoCode2.formpanel.Default = function (config) {
    config = config || {};
    ...
    msPromoCode2.formpanel.Default.superclass.constructor.call(this, config);
};
Ext.extend(msPromoCode2.formpanel.Default, MODx.FormPanel, {
...
Ext.reg('mspc2-formpanel-default', msPromoCode2.formpanel.Default);
